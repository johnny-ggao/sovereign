...
import {
  deleteTradingTrade,
  getTradingTradeStats,
  getTradingTrades,
  getTradingTradeTemplateUrl,
  importTradingTrades,
} from '@/services/api';
...
const TradingTradesPage: React.FC = () => {
            ...
            onClick={() => {
              ...
              Modal.confirm({
                ...
                onOk: async () => {
                  ...
                  await deleteTradingTrade(record.id);
  ...
  const handleImport = async () => {
    ...
    setImporting(true);
    try {
      const res = await importTradingTrades(selectedFile as File);
      if (!res.success || !res.data) {
    ...
    <PageContainer>
      ...
      <ProTable<API.TradeListItem>
        ...
        toolBarRender={() => [
          <Button
            ...
            onClick={() => {
              ...
              fetch(getTradingTradeTemplateUrl(), {
                ...
                .then((blob) => {
                  ...
                  a.href = url;
                  a.download = 'trading_trade_template.xlsx';
                  a.click();
        ...
        request={async (params) => {
          ...
          const res = await getTradingTrades({
      ...
      >
        ...
        >
          ...
          <p>支持 `.xlsx` / `.xls` 格式，按模板列顺序导入交易策略记录。</p>
        </Upload.Dragger>
...
export default TradingTradesPage;
